(function () {
  ...
  const HOME_TEXT = {
    ko: {
      ...
      quickTitle:'바로가기', quickVote:'투표', quickBgb:'BGB', quickCapital:'수도전', quickMembers:'멤버',
    ...
    en: {
      ...
      quickTitle:'QUICK LINKS', quickVote:'VOTE', quickBgb:'BGB', quickCapital:'CAPITAL WAR', quickMembers:'MEMBERS',
    ...
    pt: {
      ...
      quickTitle:'ACESSO RÁPIDO', quickVote:'VOTAÇÃO', quickBgb:'BGB', quickCapital:'GUERRA DA CAPITAL', quickMembers:'MEMBROS',
    ...
    vi: {
      ...
      quickTitle:'TRUY CẬP NHANH', quickVote:'BÌNH CHỌN', quickBgb:'BGB', quickCapital:'CHIẾN TRANH THỦ ĐÔ', quickMembers:'THÀNH VIÊN',
    ...
    ar: {
      ...
      quickTitle:'روابط سريعة', quickVote:'التصويت', quickBgb:'BGB', quickCapital:'حرب العاصمة', quickMembers:'الأعضاء',
    ...
    ja: {
      ...
      quickTitle:'クイックリンク', quickVote:'投票', quickBgb:'BGB', quickCapital:'首都戦', quickMembers:'メンバー',
    ...
    th: {
      ...
      quickTitle:'เมนูลัด', quickVote:'โหวต', quickBgb:'BGB', quickCapital:'สงครามเมืองหลวง', quickMembers:'สมาชิก',
    ...
    'zh-tw': {
      ...
      quickTitle:'快速連結', quickVote:'投票', quickBgb:'BGB', quickCapital:'首都戰', quickMembers:'成員名單',
