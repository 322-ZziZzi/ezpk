(function () {
  ...
  const HOME_TEXT = {
    ko: {
      ...
      quickTitle:'바로가기', quickSpecs:'내 스펙 수정', quickVote:'투표', quickBgb:'BGB', quickCapital:'수도전', quickMembers:'멤버',
    ...
    en: {
      ...
      quickTitle:'QUICK LINKS', quickSpecs:'EDIT MY SPECS', quickVote:'VOTE', quickBgb:'BGB', quickCapital:'CAPITAL WAR', quickMembers:'MEMBERS',
    ...
    pt: {
      ...
      quickTitle:'ACESSO RÁPIDO', quickSpecs:'EDITAR MINHAS ESPECIFICAÇÕES', quickVote:'VOTAÇÃO', quickBgb:'BGB', quickCapital:'GUERRA DA CAPITAL', quickMembers:'MEMBROS',
    ...
    vi: {
      ...
      quickTitle:'TRUY CẬP NHANH', quickSpecs:'SỬA THÔNG SỐ CỦA TÔI', quickVote:'BÌNH CHỌN', quickBgb:'BGB', quickCapital:'CHIẾN TRANH THỦ ĐÔ', quickMembers:'THÀNH VIÊN',
    ...
    ar: {
      ...
      quickTitle:'روابط سريعة', quickSpecs:'تعديل مواصفاتي', quickVote:'التصويت', quickBgb:'BGB', quickCapital:'حرب العاصمة', quickMembers:'الأعضاء',
    ...
    ja: {
      ...
      quickTitle:'クイックリンク', quickSpecs:'自分のスペックを編集', quickVote:'投票', quickBgb:'BGB', quickCapital:'首都戦', quickMembers:'メンバー',
    ...
    th: {
      ...
      quickTitle:'เมนูลัด', quickSpecs:'แก้ไขสเปกของฉัน', quickVote:'โหวต', quickBgb:'BGB', quickCapital:'สงครามเมืองหลวง', quickMembers:'สมาชิก',
    ...
    'zh-tw': {
      ...
      quickTitle:'快速連結', quickSpecs:'編輯我的規格', quickVote:'投票', quickBgb:'BGB', quickCapital:'首都戰', quickMembers:'成員名單',
