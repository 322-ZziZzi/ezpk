(() => {
  ...
  function renderPromotion(p){
    ...
    $("#promotionRouteV367").textContent=`${p.currentRank} → ${p.targetRank}`;$("#promotionTitleV367").textContent=l.title;$("#promotionCountV367").textContent=`${p.completed} / 2`;$("#promotionProgressV367").style.width=`${p.completed*50}%`;$("#promotionIndustryNameV375").textContent=lang==='ko'?'산업 레벨':'IND';$("#promotionVehicleNameV375").textContent=lang==='ko'?'차량 #1':'Vehicle #1';
